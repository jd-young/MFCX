...
#ifndef __MFCX_COLOURPOPUP_H
#define __MFCX_COLOURPOPUP_H
...
// Operations
public:
    virtual BOOL Create(CPoint p, COLORREF crColour, CWnd* pParentWnd, 
...
protected:
    ...
    virtual void FindCellFromColour(COLORREF crColour);
    ...
    virtual COLORREF GetColour(int nIndex)              { return m_crColours[nIndex].crColour; }
    virtual LPCTSTR GetColourName(int nIndex)           { return m_crColours[nIndex].szName; }
