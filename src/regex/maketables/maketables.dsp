# Microsoft Developer Studio Project File - Name="maketables" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "maketables.mak".
!MESSAGE 
...
# PROP Scc_ProjName ""$/PrEditor/v1/regex/maketables", KGAAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
PostBuild_Cmds=Release\maketables > ..\chartables.cpp
...
SOURCE="$(InputPath)"
PostBuild_Desc=Creating 'chartables.cpp'
PostBuild_Cmds=Debug\maketables > ..\chartables.cpp
# End Special Build Tool
...
# Name "maketables - Win32 Release"
# Name "maketables - Win32 Debug"
